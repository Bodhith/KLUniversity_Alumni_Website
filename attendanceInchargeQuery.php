<?php
  ...
  if( isset($_POST['queryDateSubmit']) or $_SESSION['attendanceInchargeQuery'] == 1 )
  {
    $_SESSION['attendanceInchargeQuery'] = 0;

    $flag = TRUE;

    function getQuery($date,$fId)
    {
      require "dataBaseConnection.php";

      echo "<br><br>";

      $query = "select * from student_event_details where dates='$date' and fId=$fId;" ;
  ...
  else if( isset($_POST['approveQuerySubmit']) or isset($_POST['declineQuerySubmit']) )
  {
      ...
      $query = "update student_event_details set aStatus='$status' where ".$subQuery.";" ;
